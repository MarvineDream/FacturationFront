  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Vue d'ensemble de toutes les factures du système</CardDescription>
      </CardHeader>
          ...
          <TableBody>
            {invoices.length === 0 ? (
              ...
              invoices.map((invoice) => {
                const date = new Date(invoice.issueDate).toLocaleDateString("fr-FR")
                    ...
                    <TableCell className="text-right">
                      ...
                      >
                        {downloadingId === invoice.id ? (
                          <div className="h-4 w-4 animate-spin border-b-2 rounded-full"></div>
                        ) : (
